...
class SelectionSortArrayServiceImplTest {

    private static final int[] UNSORTED = {9, 3, 7, 1, 6};
    private static final int[] EXPECTED_SORTED = {1, 3, 6, 7, 9};
    ...
    private final SelectionSortArrayServiceImpl sortService = new SelectionSortArrayServiceImpl();
